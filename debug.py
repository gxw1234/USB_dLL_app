...
import threading
import time
from common.handle_read_picture_data import *
import ctypes
import time
    ...
    def usb_open(self):
        ...
        if handle >= 0:
            ...
            if spi_init_result == 0:
                ...
                key_gpio_index = 5
                self.usb_application.GPIO_SetOpenDrain(self.serial_param, key_gpio_index,
                                                  1)  # 设置为GPIO_MODE_OUTPUT_OD模式  //@param pull_mode 上拉下拉模式：0=无上拉下拉，1=上拉，2=下拉
                self.usb_application.GPIO_Write(self.serial_param, key_gpio_index, 1)  # 默认状态 GPIO_PIN_RESET
